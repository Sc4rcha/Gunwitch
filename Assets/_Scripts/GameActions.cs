...
//     version 1.18.0
//     from Assets/_Scripts/GameActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_Scripts/GameActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @GameActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Combat"",
            ""id"": ""963348df-dcdc-4b98-a8de-8f91046595eb"",
            ""actions"": [
                {
                    ""name"": ""Shoot"",
                    ""type"": ""Button"",
                    ""id"": ""7f85bce5-d6e6-4dba-bd69-d64fc17cbb83"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""d3fc9d8c-bf76-477f-a0de-42f03a7c770a"",
    ...
    ~@GameActions()
    {
        UnityEngine.Debug.Assert(!m_Combat.enabled, "This will cause a leak and performance issues, GameActions.Combat.Disable() has not been called.");
    }
    ...
    public struct CombatActions
    {
        ...
        /// </summary>
        public CombatActions(@GameActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
